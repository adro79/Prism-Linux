...
class MediaPlayer(QWidget):
    ...
    def setupUi(self):
        ...
        self.b_first.clicked.connect(lambda: self.onFirstClicked())
        self.b_prev = QToolButton()
        self.b_prev.clicked.connect(lambda: self.onPrevClicked())
        self.b_play = QToolButton()
        self.b_play.clicked.connect(lambda: self.onPlayClicked())
        self.b_next = QToolButton()
        self.b_next.clicked.connect(lambda: self.onNextClicked())
        self.b_last = QToolButton()
        self.b_last.clicked.connect(lambda: self.onLastClicked())
